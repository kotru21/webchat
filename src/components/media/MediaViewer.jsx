...
/**
 * Компонент для просмотра изображений и видео в полноэкранном режиме
 *
 * @param {Object} media - Объект с информацией о медиа (url, type)
 * @param {function} onClose - Функция закрытия просмотрщика
 */
